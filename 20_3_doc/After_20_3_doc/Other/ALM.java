...
public class ALM {
	           ...
	           if (testtype.equals("JENKINSREGRESSION") || testtype.equals("JENKINSSMOKE"))
	           {
	        	   String[] testidslistarr = testidslist.split(",");
	    	   	   ...
	    	   	   if (almtestid.equals(last_testid_value))
	    	   	   {
		        	   ...
		        	   String email_subject = "JSF JOB SUMMARY - " + appname + " " + testtype + " in " + env_selected + " env";
		        	   ...
		        	   String email_body = b1 + b2 + b3 + b4 + b5 + b6 + b7 + b8 + b9 + b10 + b11 + b12 + b13 + b14 + b15 + b16 + b17 + b18 + b19 + b20 + b21;
	...
	public static Object fw_update_hpalm_test_case_execution_status_backup20170625(Object run_id_value, String strTestCaseId, String strStatus) throws IOException, InterruptedException, KeyManagementException, NoSuchAlgorithmException, ClassNotFoundException, SQLException 
	{
		...
		// Added for TestID-ConfigID input (if needed)
		String expected_config_id = "";
		String original_strTestCaseId = strTestCaseId;
		
		if (strTestCaseId.contains("-"))
		{
			String[] strTestCaseId_arr = strTestCaseId.split("-");
			strTestCaseId = strTestCaseId_arr[0];
			expected_config_id = strTestCaseId_arr[1];
			
		}
		// End of Added for TestID-ConfigID input (if needed)
		*/
		
		//System.out.println("ALM Test ID: " + strTestCaseId);
		//System.out.println("Expected Config ID: " + expected_config_id);
		
		//comm.fw_execute_xml("ALMRunStatusUpdate", "https://alm.corp.chartercom.com/qcbin/rest/domains/DESKTOP/projects/Gateway/runs", "chtr\\melking:Blue1225", "CONFIG_ID,2863", 0);
       ...
       //System.out.println("Run ID: " + run_id_value);
