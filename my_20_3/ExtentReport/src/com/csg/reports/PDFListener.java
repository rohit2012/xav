...
public class PDFListener implements ITestListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		Paragraph p = new Paragraph("PASSED TESTS  -" + result.getMethod(), new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE, Font.BOLD));
	...
	{
		log("onStart("+context+")");
		file = new File(Reporting.getPath()+"\\Reports\\ExtentReport.pdf");
