	...
	public static Object[][]  getData(String testCase,Xls_Reader xls){
		...
		public static void validateTestExecution(String testCaseName,
			...
			if(!Utility.isSuiteRunnable(testSuiteName)){
				Skip.skipatsuitelevel(testSuiteName);
			...
			if(!Utility.isTestCaseRunnable(testCaseName,xls)){
				Skip.skipattestlevel(testCaseName);
		...
		public static Logger initLogs(String testName,String append){
			FileAppender appender = new FileAppender();
			// configure the appender here, with file location, etc
			appender.setFile(System.getProperty("user.dir")+"\\executioninfo\\logs"+"\\"+testName+"\\"+append+".log");
